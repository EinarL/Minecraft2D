...
{
	private static Hashtable digBehaviours;
	private static Hashtable itemDropBehaviours;
	private static Hashtable rightClickBehaviours;
	private static Hashtable blockToStepSoundFolder;
	private static object[] prevStepSound;
	private static Hashtable rightClickItemBehaviours;
	private static Hashtable stepSoundPitches;



	public static void initializeHashtables()
	{
		digBehaviours = new Hashtable() { // hashtable that holds the class for the different block sounds and speed when breaking them
			{ "Dirt", new BreakDirt() },
		...
		blockToStepSoundFolder = new Hashtable()
		{
		...
		stepSoundPitches = new Hashtable()
		{
